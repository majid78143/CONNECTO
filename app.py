    ...
    if not firebase_admin._apps:
        if FIREBASE_SERVICE_ACCOUNT:
            try:
                ...
                print("[CONNECTO] ✅ Firebase Admin SDK initialized")

            except Exception as e:
                print(f"[CONNECTO] ❌ Firebase initialization failed: {e}")
        else:
            print(
                "[CONNECTO] ⚠️ Firebase Admin SDK not initialized — service account missing"
            )
